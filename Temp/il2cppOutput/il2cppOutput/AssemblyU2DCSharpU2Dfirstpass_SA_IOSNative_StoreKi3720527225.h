...
struct  TransactionsHandlingMode_t3720527225 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TransactionsHandlingMode_t3720527225, ___value___1)); }
