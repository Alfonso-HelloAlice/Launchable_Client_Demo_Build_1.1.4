...
struct  MP_MusicPlaybackState_t2364713801 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MP_MusicPlaybackState_t2364713801, ___value___1)); }
