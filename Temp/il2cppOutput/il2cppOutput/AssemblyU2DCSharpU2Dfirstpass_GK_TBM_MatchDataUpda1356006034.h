...
struct  GK_TBM_MatchDataUpdateResult_t1356006034  : public Result_t4287219743
{
public:
...
public:
	inline static int32_t get_offset_of__Match_1() { return static_cast<int32_t>(offsetof(GK_TBM_MatchDataUpdateResult_t1356006034, ____Match_1)); }
