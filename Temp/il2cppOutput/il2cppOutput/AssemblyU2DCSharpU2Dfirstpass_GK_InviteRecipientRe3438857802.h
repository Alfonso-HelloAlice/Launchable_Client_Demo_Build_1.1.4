...
struct  GK_InviteRecipientResponse_t3438857802 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GK_InviteRecipientResponse_t3438857802, ___value___1)); }
