...
struct  SA_EditorNotificationType_t2256397131 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SA_EditorNotificationType_t2256397131, ___value___1)); }
