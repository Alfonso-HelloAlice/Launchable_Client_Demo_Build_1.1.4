...
struct  GP_TBM_MatchTurnStatus_t2221730550 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GP_TBM_MatchTurnStatus_t2221730550, ___value___1)); }
