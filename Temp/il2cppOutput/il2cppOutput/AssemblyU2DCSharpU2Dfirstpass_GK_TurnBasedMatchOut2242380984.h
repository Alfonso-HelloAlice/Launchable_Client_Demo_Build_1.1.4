...
struct  GK_TurnBasedMatchOutcome_t2242380984 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GK_TurnBasedMatchOutcome_t2242380984, ___value___1)); }
