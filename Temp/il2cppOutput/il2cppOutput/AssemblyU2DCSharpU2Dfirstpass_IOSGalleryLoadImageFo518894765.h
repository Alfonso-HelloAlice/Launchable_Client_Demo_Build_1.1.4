...
struct  IOSGalleryLoadImageFormat_t518894765 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(IOSGalleryLoadImageFormat_t518894765, ___value___1)); }
