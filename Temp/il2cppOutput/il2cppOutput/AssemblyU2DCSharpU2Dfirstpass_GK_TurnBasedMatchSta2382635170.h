...
struct  GK_TurnBasedMatchStatus_t2382635170 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GK_TurnBasedMatchStatus_t2382635170, ___value___1)); }
